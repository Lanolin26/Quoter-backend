...
import static util.Utils.MAX_QUOTE_SOURCE_ENTITIES;
import static util.Utils.MAX_QUOTE_SOURCE_TYPE_ENTITIES;
...
class QuoteSourceServiceTest {
    ...
    void _02_addNewValue() {
        ...
        assertNotNull(createdEntity.getType().getId());
    ...
    void _04_changeTypeFieldById() {
        ...
        assertNotNull(update.getId());
        assertNotNull(update.getType());
        assertNotNull(update.getType().getId());
    ...
    void _05_changeTypeFieldByObject() {
        ...
        // THEN
        assertTrue(sourceTypeOptional.isPresent());
    ...
    void _06_deleteEntityById() {
        ...
        assertTrue(quoteSourceService.getOne(id).isPresent());
        // WHEN
        int oldSize = quoteSourceService.findAll().size();
