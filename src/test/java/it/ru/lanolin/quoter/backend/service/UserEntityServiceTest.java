...
class UserEntityServiceTest {
    ...
    private void assertEqualsUserEntity(UserEntity expected, UserEntity actual) {
        assertNotNull(expected, "NPE");
        assertNotNull(actual, "NPE");
        assertAll(
                () -> assertEquals(expected.getId(), actual.getId(), "Not equals ID field"),
                () -> assertEquals(expected.getName(), actual.getName(), "Not equals NAME field"),
                () -> assertEquals(expected.getLogin(), actual.getLogin(), "Not equals LOGIN field"),
                () -> assertEqualsPassword(expected.getPassword(), actual.getPassword()),
                () -> assertEquals(expected.getImg(), actual.getImg(), "Not equals IMG field"),
                () -> assertEquals(expected.getRoles(), actual.getRoles(), "Not equals ROLES field"),
                () -> assertEquals(expected.getRoles().size(), actual.getRoles().size(), "Not equals ROLES field"),
                () -> assertEquals(expected, actual, "Not equals OBJECTS")
        );
    }
    ...
    void _02_addNewValue() {
        ...
        assertEqualsUserEntity(newValue, savedValue);
    }
    ...
    void _03_updateNameField() {
        ...
        // THEN
        assertEqualsUserEntity(userEntity, update);
    }
    ...
    void _08_updateRoleField_2() {
        ...
        if (userEntity.getRoles().size() == 0) {
            userEntity.getRoles().add(UserRoles.GUEST);
        }
        UserEntity update = Assertions.assertDoesNotThrow(() -> userEntityService.update(id, userEntity));
        // THEN
        assertEqualsUserEntity(userEntity, update);
